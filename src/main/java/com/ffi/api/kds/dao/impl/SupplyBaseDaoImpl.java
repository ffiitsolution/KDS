...
public class SupplyBaseDaoImpl implements SupplyBaseDao {
    ...
    public List<Map<String, Object>> friedQueueOrder() {
        ...
        List<Map<String, Object>> friedResult = jdbcTemplate.query(friedQuery, new HashMap<>(), new DynamicRowMapper());
        for (Map<String, Object> fried : friedResult) {
            ...
            List<Map<String, Object>> itemDetailResult = jdbcTemplate.query(itemDetailQuery, new MapSqlParameterSource()
    ...
    public List<Map<String, Object>> pastaQueueOrder() {
        ...
        List<Map<String, Object>> pastaResult = jdbcTemplate.query(pastaQuery, new HashMap<>(), new DynamicRowMapper());
